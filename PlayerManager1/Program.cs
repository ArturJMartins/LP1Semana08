...
namespace PlayerManager1 // >>> Change to PlayerManager2 for exercise 4 <<< //
{
    ...
    public class Program
    {
        ...
        private void ShowMenu()
        {
            ...
            Console.Write("Choose with a number your choice: ");
        }
        ...
        private void InsertPlayer()
        {
            ...
            {
                Console.WriteLine("Please choose a valid score number.");
                Console.Write("Player score: ");
            }
        ...
        {
            Console.Write("Choose minimum score: ");
            int minScore;
            while (!int.TryParse(Console.ReadLine(), out minScore))
            {
                Console.WriteLine("Choose a valid score number!");
                Console.Write("Choose minimum score: ");
            }

            var higherPlayers = GetPlayersWithScoreGreaterThan(minScore);
            ListPlayers(higherPlayers);
        }
        ...
        {
            List<Player> higherPlayerList = new List<Player>();
            foreach (Player player in playerList)
            {
                if (player.Score > minScore)
                {
                    higherPlayerList.Add(player);
                }
            }
            return higherPlayerList;
        }
    }
}